                      ...
                      <button 
                        ...
                        style={{
                          background: processing 
                            ? 'linear-gradient(45deg, #f5f1f1, #f2eeee)' 
    ...
    <div className="content-view fade-in">
      <div className="container">
        ...
        {cart.length === 0 ? (
          <div className="cart-container text-center py-5">
            <div className="py-5">
              <i className="bi bi-cart-x text-white" style={{ fontSize: '5rem' }}></i>
                  ...
                  <div key={item.id} className="cart-item border-bottom border-secondary pb-4 mb-4">
                    <div className="row align-items-center">
                      ...
                      <div className="col-md-5">
                        ...
                        <p className="text-white mb-1">{item.artist}</p>
                  ...
                  <button 
                    ...
                    style={{
                      background: isLoggedIn
                        ? 'linear-gradient(45deg, #00ff88, #00cc66)'
                        : 'linear-gradient(45deg, #f9f5f5, #ffffff)',
                      border: `2px solid ${isLoggedIn ? '#00ff88' : '#fefbfb'}`,
                      color: 'white',
