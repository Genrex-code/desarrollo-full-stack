      ...
      <div className="container-fluid px-4">
        ...
        {activeTab === 'products' ? (
          ...
          <div className="text-center py-5 text-muted bg-glass-dark rounded">
            ...
            <p className="mt-3">No hay órdenes registradas todavía.</p>
          </div>
        )}
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4 mb-3">
                          ...
                          >
                            ...
                            <option value="Indie">New Wave</option>
                            <option value="Indie">Acid Jazz</option>
                            <option value="Indie">Funk</option>
                            <option value="Indie">Alternative</option>
                            <option value="Indie">Hip-Hop</option>
                            <option value="Indie">Country</option>
                          </select>
                        </div>
