// src/pages/Formatos.jsx - VERSIÓN CON FILTRO DE GÉNEROS
...
const Formatos = () => {
  ...
  const [genreFilter, setGenreFilter] = useState('all'); // NUEVO
            ...
            {filteredProducts.map(product => (
              <div key={product.id} className="col">
                <Link to={`/album/${product.id}`} className="text-decoration-none">
                  <div className="format-item-card clickable-card">
                    <div 
